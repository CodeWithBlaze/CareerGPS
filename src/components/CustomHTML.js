...
function CustomHTML({content,task_id,setCelebrate,setActiveTask,taskContent,showCompleteButton=true}) {
    ...
    return (
        ...
        {
            showCompleteButton && <div className='task-details-mark-complete-btn'>
